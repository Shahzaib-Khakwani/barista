<script>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center mb-8">
        ...
        <div class="flex items-center space-x-6 mb-4 md:mb-0">
          <a href="/menu" class="uppercase font-bold hover:text-gray-300">Menu</a>
          <a href="/shop" class="uppercase font-bold hover:text-gray-300">Shop</a>
          <a href="/about" class="uppercase font-bold hover:text-gray-300">About</a>
          <a href="/order" class="uppercase font-bold hover:text-gray-300">Order</a>
        </div>
      ...
      <!-- Copyright and Links -->
      <div class="text-center md:text-left border-t border-gray-800 pt-6">
        <div class="flex flex-col md:flex-row justify-center md:justify-between items-center text-sm">
          ...
          <div class="flex space-x-6">
            ...
            <a href="/settings" class="hover:text-gray-300">Coffee Settings</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Large Tagline at the bottom -->
  <div class="bg-black text-white px-4 pb-12">
    <div class="container mx-auto">
      <h1 class="text-5xl md:text-8xl font-bold tracking-tighter">That's Damn Good™</h1>
    </div>
  </div>